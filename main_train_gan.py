...
def main(option_path='options/train_lepeswinsr_gan.yaml'):  # options/train_urrdb_psnr.yaml
    '''
    # ----------------------------------------
    # Step--1 (prepare opt)
    # ----------------------------------------
    ...
    if opt['resume'] == True:
        ...
        init_itet_optimizerD, init_path_optimizerD = option.find_last_checkpoint(opt['path']['models'], net_type='optimizerD')
    else:
        init_iter_G, init_iter_D = 0, 0
        init_path_G, init_path_D = opt['path']['pretrained_netG'], opt['path']['pretrained_netD']
        init_iter_optimizerG, init_iter_optimizerD = 0, 0
        init_path_optimizerG, init_path_optimizerD = None, None
